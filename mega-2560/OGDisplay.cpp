...
void DisplayLib::updateDisplay(
    ...
    tft.fillRect(90, 50, 128, 140, ST7735_GREEN);
    ...
    tft.fillRect(45, 140, 128, 160, LightGrey);

    tft.setCursor(50, 140);
    tmpMsg = String(int(ph_min)) + "/" + String(int(ph_max));
    tft.print(tmpMsg);

    tft.setCursor(50, 150);
    tmpMsg = String(int(tds_min)) + "/" + String(int(tds_max));
    tft.print(tmpMsg);
}
